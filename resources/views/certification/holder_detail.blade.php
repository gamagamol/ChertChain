                    ...
                    <div class="row">
                        <div class="col">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="/certification/update_sign">
                                    @csrf

                                    <input type="text" name="id_certificate" value="{{$data[0]->id_certificate}}" hidden>
                                    <input type="text" name="type" value="holder" hidden>
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <button class="btn btn-primary mt-4"> Sign</button>
                                        
                                        <a href="{{ url('/certification/sign') }}" class="btn btn-primary mt-4">Back</a>
                                    </div>
