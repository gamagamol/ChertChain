...
@section('content')
  <div class="row justify-content-center">
            <div class="col-md-6 ">
                <div class="card o-hidden border-0 shadow-lg my-5 mt-5 " style="height:700px;background-color:#D9D9D9;">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="login">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control form-control-user @error('holder') is-invalid @enderror my-2"
                                                placeholder="Enter holder" name="holder">
                                            @error('holder')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control form-control-user @error('signer') is-invalid @enderror my-2"
                                                placeholder="Enter signer" name="signer">
                                            @error('signer')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
